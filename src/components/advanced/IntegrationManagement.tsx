      ...
      const mockIntegrations: Integration[] = [
        {
          id: 'salesforce',
          name: 'Salesforce',
          description: 'Sync opportunities and contacts with Salesforce CRM',
          category: 'automation',
          status: 'connected',
          icon: <Database className="h-5 w-5" />,
          lastSync: new Date(Date.now() - 30 * 60 * 1000).toISOString(),
          features: ['Bidirectional sync', 'Real-time updates', 'Custom fields']
        },
        {
          id: 'gmail',
          name: 'Gmail',
          ...
          features: ['Email tracking', 'Templates', 'Auto-logging']
        },
        {
          id: 'calendar',
          ...
          features: ['Meeting scheduling', 'Availability sync', 'Reminders']
        },
        {
          id: 'slack',
          name: 'Slack',
          ...
          features: ['Channel notifications', 'Deal alerts', 'Team updates']
        },
        {
          id: 'hubspot',
          name: 'HubSpot',
          description: 'Import leads and marketing data from HubSpot',
          category: 'automation',
          status: 'available',
          icon: <ExternalLink className="h-5 w-5" />,
          features: ['Lead import', 'Marketing data', 'Contact scoring']
        },
        {
          id: 'zoom',
          name: 'Zoom',
          description: 'Schedule and join meetings directly from opportunities',
          category: 'communication',
          status: 'error',
      ...
      const mockApiKeys: APIKey[] = [
        {
          ...
          permissions: ['read:opportunities', 'write:activities', 'read:contacts']
        },
        {
          id: '2',
      ...
      const mockWebhooks: Webhook[] = [
        {
          ...
          events: ['opportunity.closed_won', 'opportunity.closed_lost'],
          status: 'active',
        ...
        },
        {
          ...
          events: ['activity.created', 'activity.completed'],
          status: 'active',
