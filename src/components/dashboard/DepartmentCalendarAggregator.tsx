...
export function DepartmentCalendarAggregator({ selectedDivision, selectedRep, dateRange }: DepartmentCalendarAggregatorProps) {
  ...
  useEffect(() => {
    ...
    const mockEvents: CalendarEvent[] = [
      ...
      {
        id: "2",
        title: "Division Standup",
        type: "meeting",
        startTime: new Date(Date.now() + 24 * 60 * 60 * 1000),
        endTime: new Date(Date.now() + 24 * 60 * 60 * 1000 + 30 * 60 * 1000),
        location: "Virtual",
        division: "South",
        organizer: { name: "Mike Davis", initials: "MD" },
        attendees: [
          { name: "Mike Davis", initials: "MD" },
          { name: "Lisa Chen", initials: "LC" },
          { name: "Team Members", initials: "TM" }
        ],
        priority: "medium"
      },
      {
        id: "3",
        title: "Contract Review - Global Solutions",
        type: "review",
        startTime: new Date(Date.now() + 48 * 60 * 60 * 1000),
        endTime: new Date(Date.now() + 48 * 60 * 60 * 1000 + 45 * 60 * 1000),
        division: "East",
        customerName: "Global Solutions Ltd",
        organizer: { name: "Tom Wilson", initials: "TW" },
        attendees: [
          { name: "Tom Wilson", initials: "TW" },
          { name: "Legal Team", initials: "LT", isExternal: true }
        ],
        priority: "high"
      },
      {
        ...
        endTime: new Date(Date.now() + 72 * 60 * 60 * 1000 + 2 * 60 * 60 * 1000),
        location: "Training Center",
        division: "West",
        organizer: { name: "Anna Garcia", initials: "AG" },
        attendees: [
          { name: "All West Division", initials: "WD" }
        ],
        priority: "medium"
      },
      {
        ...
        customerName: "Euro Dynamics",
        organizer: { name: "International Team", initials: "IT" },
        attendees: [
          { name: "International Team", initials: "IT" },
          { name: "Euro Dynamics", initials: "ED", isExternal: true }
        ],
        priority: "high"
      }
    ];
    ...
    if (selectedDivision !== "all") {
      filteredEvents = filteredEvents.filter(event =>
        event.division.toLowerCase() === selectedDivision.toLowerCase()
      );
    }
