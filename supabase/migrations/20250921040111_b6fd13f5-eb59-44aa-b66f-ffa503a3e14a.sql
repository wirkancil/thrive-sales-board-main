-- Phase 1: Foundation & Role Enhancement Migration (Fixed v2)

-- First, drop the existing role constraint
ALTER TABLE public.user_profiles DROP CONSTRAINT IF EXISTS user_profiles_role_check;

-- Create enums for user status and other lookups (without IF NOT EXISTS)
DO $$ 
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'audit_object_type') THEN
