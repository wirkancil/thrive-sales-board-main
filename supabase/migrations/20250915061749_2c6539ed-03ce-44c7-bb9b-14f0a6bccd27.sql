-- Phase 1: Simplified RBAC Schema Design
...
-- Update existing RLS policies to work with new role system (keeping old system for now)
-- We'll migrate data and policies in subsequent phases
