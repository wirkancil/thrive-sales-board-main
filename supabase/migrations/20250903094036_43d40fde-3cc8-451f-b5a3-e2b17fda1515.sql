-- Two-Phase CRM Master Data Model Implementation (Part 1)
-- Skip role changes for now and focus on core schema
...
-- Migrate data from organizations if it exists and companies is empty
...
-- ============================================================================
-- 4. MODIFY USER PROFILES (without role enum changes)
-- ============================================================================
...
-- Ensure end_user_id is populated (but don't make it NOT NULL yet)
