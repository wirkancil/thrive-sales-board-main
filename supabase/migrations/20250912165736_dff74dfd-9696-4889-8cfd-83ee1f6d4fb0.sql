...
-- 1. Fix User Profile Access Control - Drop existing broad policies first
...
-- Drop existing user_profiles policies to recreate them with proper restrictions
DROP POLICY IF EXISTS "Users can view own profile" ON public.user_profiles;
DROP POLICY IF EXISTS "Division heads can view their division members" ON public.user_profiles;
DROP POLICY IF EXISTS "Dept heads can view their department members" ON public.user_profiles;
