-- Fix search path for all functions with correct signatures
...
ALTER FUNCTION public.create_deal_from_activity(uuid, numeric, text, uuid) SET search_path = 'public';
