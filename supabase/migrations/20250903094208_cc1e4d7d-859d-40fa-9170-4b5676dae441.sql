-- Two-Phase CRM Master Data Model Implementation (Part 1 - Core Schema)
...
-- ============================================================================
-- 3. MASTER DATA - COMPANIES (Customer & End User)
-- ============================================================================

-- Create companies table (reusing organizations structure if available)
...
-- Migrate data from organizations if companies is empty
...
-- ============================================================================
-- 6. ENHANCE OPPORTUNITIES (Phase 1)
-- ============================================================================
...
-- Backfill end_user_id from customer_id where missing
...
CREATE INDEX IF NOT EXISTS idx_opportunities_approval_status ON public.opportunities(approval_status);

-- ============================================================================
-- 7. PIPELINE ITEMS (Phase 2)
-- ============================================================================
...
-- End user defaulting trigger on opportunities
