...
-- Policies exist count
select polname, tablename from pg_policies where schemaname='public' and tablename in ('user_profiles','deals','sales_activity','reports','events','contacts','analytics') order by tablename, polname;